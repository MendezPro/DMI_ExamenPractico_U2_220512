import 'package:cinemapedia_220512/infrastructure/mappers/movie_mapper.dart';
import 'package:cinemapedia_220512/domain/datasources/movies_datasource.dart';
import 'package:cinemapedia_220512/infrastructure/models/moviedb/moviedb_response.dart';
...
class MoviedbDataSource extends MoviesDatasource{
  ...
  Future<List<Movie>> getNowPlaying({int page = 1}) async {
    ...
    /// Realiza petición GET al endpoint de películas populares
    ...
    /// Realiza petición GET al endpoint de películas próximas
    ...
    /// Realiza petición GET al endpoint de películas mejor valoradas
    ...
    /// Realiza petición GET al endpoint de películas mexicanas
